package com.rguz.moviewatchlist.adapter;
...
import com.rguz.moviewatchlist.R;
            ...
            view.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v){
                    ...
                    if (pos != RecyclerView.NO_POSITION){
                        ...
                        Toast.makeText(v.getContext(), "Opening trailer for " + clickedDataItem.getName(), Toast.LENGTH_SHORT).show();
                    }
                }
            });
